...
The configuration file for train_cpc_model.py.
...
future_predicted_timesteps = [1, 6, 12]
...
name_of_log_textfile = 'cpc_trainlog.txt'
...
encoder_best_model_name = 'CPC_Encoder_mlp_best_model.pt'
ar_best_model_name = 'CPC_AR_mlp_best_model.pt'
